...
data_path = "G:\\documents\\Weddell_seals\\data_TDR\\data\\" # path where your TDR files are stored (after ZOC)
fig_path="G:\\documents\\Weddell_seals\\article_2\\script\\figure\\" # path for figures to be stored
